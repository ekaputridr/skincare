...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="vanilla milk tone.png" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">Vanilla Milk Toner</h4>
            <h5>IDR 502.000,00</h5>
                <p class="card-text">Our gentle alcohol-free facial toner helps replenish the look and feel of your skin. It is formulated with avocado oil, kiwi seed oil and apple extract to help soothe, tone and restore natural hydration. This toner helps unclog, purify and minimize the appearance of pores.</p>
          </div>
