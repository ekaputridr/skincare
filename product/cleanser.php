  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Product</a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="../product/home.php">h o m e</a>
...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="foaming face wash2.png" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">Foaming Face Wash</h4>
            <h5>IDR 362.000,00</h5>
                <p class="card-text">Our luxurious foaming face wash is infused with ultra-nourishing kiwi seed oil, packed with Vitamin C and E to help maintain moisture and improve elasticity.</p>
          </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
            <img class="card-img-top" src="i2.png" alt="">
                <div class="card-body">
                <h4 class="card-title">Coconut Scrub</h4>
                <h5>IDR 413.900</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
            <img class="card-img-top" src="walnut scrub2.png" alt="">
              <div class="card-body">
                <h4 class="card-title">Walnut Face Scrub</h4>
                <h5>IDR 350.000</h5>
                <p class="card-text">Our gentle yet effective face scrub is packed with a cocktail of anti-inflammatory ingredients and skin-smoothing fruit extracts that buff away dead skin cells to reveal a soft, radiant complexion.</p>
              </div>
              <div class="card-footer">
                <small class="text-muted">&#9733; &#9733; &#9733; &#9733; &#9734;ㅤ</small>
                <a href="#"><img src="shop.png" style="height:20px"></a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
            <img class="card-img-top" src="i3.png" alt="">
              <div class="card-body">
                <h4 class="card-title">Makeup Removing Wipes</h4>
                <h5>IDR 63.999</h5>
                <p class="card-text">Our cleansing towelettes remove dirt, oil and makeup, leaving your skin feeling fresh and looking clean.</p>
              </div>
              <div class="card-footer">
                <small class="text-muted">&#9733; &#9733; &#9733; &#9733; &#9734;ㅤ</small>
                <a href="#"><img src="shop.png" style="height:20px"></a>
