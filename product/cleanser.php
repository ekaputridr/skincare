...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="walnut scrub2.png" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Walnut Face Scrub</a>
                </h4>
                <h5>IDR 350.000</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="i3.png" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Makeup Removing Wipes</a>
                </h4>
                <h5>IDR 63.999</h5>
