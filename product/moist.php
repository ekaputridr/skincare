...
<head>
    ...
    <title>Macflari | Moisturizer</title>
...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="face moist2.png" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
                <a href="#">Face Moisturizer</a>
            </h4>
            <h5>IDR 311.400,00</h5>
                <p class="card-text">Our face moisturizer includes a combination of humectants and emollients that help hydrate skin without heaviness, greasiness or oiliness. </p>
          </div>
