...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="face lip mask bundle2.png" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
                <a href="#">Face & Lip Mask Bundle</a>
            </h4>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="face mask2.png" alt=""></a>
                <div class="card-body">
                <h4 class="card-title">
                    <a href="#">Hydrating Face Mask</a>
                </h4>
                <h5>IDR 403.000</h5>
                <p class="card-text">Indulge your skin with our hydrating face mask. Formulated to soothe, moisturize and improve the look and feel of your skin, while helping reduce puffiness. The formula is packed with antioxidants, vitamins and essential ceramides to help moisturize and nourish the skin.</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="i1.png" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Hydrating Lip Mask</a>
                </h4>
                <h5>IDR 250.200</h5>
