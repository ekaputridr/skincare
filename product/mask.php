...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <img class="card-img-top" src="face lip mask bundle2.png" alt="">
          <div class="card-body">
            <h4 class="card-title">Face & Lip Mask Bundle</h4>
            <h5>IDR 584.000,00</h5>
                <p class="card-text">Indulge your skin with our hydrating face mask. Formulated to soothe, moisturize and improve the look and feel of your skin, while helping reduce puffiness. The formula is packed with antioxidants, vitamins and essential ceramides to help moisturize and nourish the skin.</p>
          </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <img class="card-img-top" src="face mask2.png" alt="">
                <div class="card-body">
                <h4 class="card-title">Hydrating Face Mask</h4>
                <h5>IDR 403.000</h5>
                <p class="card-text">Indulge your skin with our hydrating face mask. Formulated to soothe, moisturize and improve the look and feel of your skin, while helping reduce puffiness. The formula is packed with antioxidants, vitamins and essential ceramides to help moisturize and nourish the skin.</p>
              </div>
              <div class="card-footer">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
            <img class="card-img-top" src="i1.png" alt="">
              <div class="card-body">
                <h4 class="card-title">Hydrating Lip Mask</h4>
                <h5>IDR 250.200</h5>
                <p class="card-text">Our hydrating lip mask is a moisturizing balm that helps restore dry lips. It is formulated with a blend of oils, shea butter and Vitamin E to help lock in moisture, leaving your lips feeling smooth, soft and supple.</p>
              </div>
              <div class="card-footer">
                <small class="text-muted">&#9733; &#9733; &#9733; &#9733; &#9734;ㅤ</small>
                <a href="#"><img src="shop.png" style="height:20px"></a>
