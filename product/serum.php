...
<div class="row">
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="vitamin c serum2.png" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">Vitamin C Serum</h4>
            <h5>IDR 421.500,00</h5>
                <p class="card-text">Our Vitamin C Serum is packed with ingredients that penetrate the skin to help brighten and help improve overall skin health.</p>
          </div>
