...
<div class="kotak_login">
    <p class="tulisan_login">EDIT PROFILE</p>
        <form action="update.php" method="POST">
        <table>
            <tr>
                <td><label>First Name</label></td>
                <td><input type="text" name="fname" class="form_login" placeholder="first name" id="fname" value="<?php echo $row['fname']; ?>"></td>
            </tr>
            <tr>
                <td><label>Last Name</label></td>
                <td><input type="text" name="lname" class="form_login" placeholder="last name" id="lname" value="<?php echo $row['lname']; ?>"></td>
            </tr>
            <tr>
                <td><label>Birthday</label></td>
                <td><input type="text" name="birthday" class="form_login" placeholder="dd/mm/yy" id="birthday" value="<?php echo $row['birthday']; ?>"></td>
            </tr>
            <tr>
                <td><label>Email</label></td>
                <td><input type="email" name="email" class="form_login" placeholder="e-mail" id="email" value="<?php echo $row['email']; ?>"></td>
            </tr>
            <tr>
                <td><label>Password</label></td>
                <td><input type="password" name="password" class="form_login" placeholder="password" id="password" value="<?php echo $row['password']; ?>"></td>
            </tr>
        </table><br><br><br>
        <input type="submit" class="tombol_login" value="SAVE"></td><br><br>
